...
values('nguyen_test','Nguyễn Văn Test','Nam','nguyentest@gmail.com','123','1995-01-01','Hà Nội');

-- Kiểm tra lại view (PHẢI THẤY USER MỚI)
select * from view_users_firstname;
...
-- Kiểm tra lại view (KHÔNG CÒN USER ĐÓ)
select * from view_users_firstname;
